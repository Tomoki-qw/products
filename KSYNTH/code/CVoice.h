...
public:
	...
	//加算方式アナログシンセモード
	double additiveSynth(double amp);
	
	//FMシンセモード
	double FMSynth(double amp);
	...
	void setFilterFreq(int tag, float value);

	void setFilterQ(int tag, float value);

	void setFilterType(int tag, float type);

	void setFilterGain(int tag, float value);
};
