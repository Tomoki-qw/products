...
namespace Steinberg {
	namespace Vst {
		...
		protected:
			...
			//filter
			CControl* o1FilterFreq;
			CControl* o1FilterQ;
			CControl* o1FilterGain;

			CControl* o2FilterFreq;
			CControl* o2FilterQ;
			CControl* o2FilterGain;

			CControl* o3FilterFreq;
			CControl* o3FilterQ;
			CControl* o3FilterGain;
		...
		public:
			...
			void createComboboxFilter(ParamID tag, int x, int y);
